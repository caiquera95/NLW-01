...
//Interface representa o formato que o objeto vai ter
interface Item {
    id:number, 
    title:string;
    image_url: string;
...
const CreatePoint = () => {
    ...
    useEffect(()=> {
        //Retornando a posição inicial do usuário assi que abrir a app
    ...
    //Segundo parametro quando quero executar essa função
    useEffect(() => {  
    ...
    useEffect (() => {
        //Não mostrar nada se nenhuma UF for selecionada
        if (selectedUf === '0'){
            return;
        }
